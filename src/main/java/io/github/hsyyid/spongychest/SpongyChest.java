...
public class SpongyChest
{
	...
	//public static HologramsService hologramService;
	...
	public void onServerInit(GameInitializationEvent event)
	{
		...
		Sponge.getCommandManager().register(this, spongyChestCommandSpec, "qs", "quickshop");

		Sponge.getEventManager().registerListeners(this, new InteractBlockListener(this));
		Sponge.getEventManager().registerListeners(this, new HitBlockListener(this));
		...
		getLogger().info("Devco Custom was Edited by axle2005");
	...
	public void onPostInit(GamePostInitializationEvent event)
	{
		...
		/*Excess Hologram Code
		Optional<HologramsService> hologramsServiceOptional = Sponge.getServiceManager().provide(HologramsService.class);
		if(hologramsServiceOptional.isPresent())
		{
			hologramService = hologramsServiceOptional.get();
		}
		else
		{
			getLogger().error("HologramsAPI not available! Is the plugin 'holograms' installed?");
		}*/
	}
}
